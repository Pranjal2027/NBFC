...
public class TC_25_post_credit_note extends Base_Class_2
{
    @BeforeClass
	public void setup()
	{
    ...
    @Test
	public void credit_note_add()
	{
		JSONObject request=new JSONObject();
		String token =TokenProvider.getInstance().getToken();
		File testUploadFile = new File ("Excel/invoice_uploadCN.ods");
		...
		Response response = given()
				...
				.when().
				post(CONTEXTPATH+"invoice/upload-invoice-excel");

...
public class TC_08_NBFC_Pin_Code_Post extends Base_Class
{
    ...
    @Test
    public void nbfc_pincode_blank()
    {
    ...
    @Test
    public void nbfc_pincode_capital_letter()
    {
    	JSONObject request=new JSONObject();
		String token =TokenProvider.getInstance().getToken();
    ...
    @Test
    public void nbfc_pincode_small_letters()
    {
    	JSONObject request=new JSONObject();
		String token =TokenProvider.getInstance().getToken();
    ...
    @Test
    public void nbfc_pincode_less_6()
    {
    	JSONObject request=new JSONObject();
		String token =TokenProvider.getInstance().getToken();
    ...
    @Test
    public void nbfc_pincode_more_6()
    {
    	JSONObject request=new JSONObject();
		String token =TokenProvider.getInstance().getToken();

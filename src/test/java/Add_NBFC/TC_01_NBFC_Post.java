...
public class TC_01_NBFC_Post extends Base_Class
{
	...
	public void nbfc_post()
	{
		...
		String token =TokenProvider.getInstance().getToken();
		 ...
		 request.put("nbfc_email", "pranjal.gawade@tech-trail.com");
		 request.put("nbfc_mobile", "8149382120");
		...
		// request.put("nbfc_ifsc_code", "SBIN0013280");
		 ...
		 request.put("last_name", "Gawade");
		 request.put("email", "pranjal.gawade@tech-trail.com");
		 request.put("mobile_number", "8149382120");

...
public class TC_04_NBFC_Mobile_Post extends Base_Class
{
   ...
   public void setup()
   {
	...
	@Test
	public void nbfc_mobile_letter()
	{
		JSONObject request=new JSONObject();
		String token =TokenProvider.getInstance().getToken();
	...
	@Test
	public void nbfc_mobile_less_10()
	{
		JSONObject request=new JSONObject();
		String token =TokenProvider.getInstance().getToken();
	...
	@Test
	public void nbfc_mobile_more_10()
	{
		JSONObject request=new JSONObject();
		String token =TokenProvider.getInstance().getToken();
	...
	@Test
	public void nbfc_mobile_special_char()
	{
		JSONObject request=new JSONObject();
		String token =TokenProvider.getInstance().getToken();

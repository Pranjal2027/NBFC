...
public class TC_03_NBFC_Email_Post extends Base_Class
{
	...
	public void nbfc_email_blank()
   {
	...
	@Test
	public void nbfc_email_missing_symbol()
	{
		JSONObject request=new JSONObject();
		String token =TokenProvider.getInstance().getToken();
	...
	@Test
	public void nbfc_email_special_char()
	{
		JSONObject request=new JSONObject();
		String token =TokenProvider.getInstance().getToken();
	...
	@Test
	public void nbfc_email_double_symbol()
	{
		JSONObject request=new JSONObject();
		String token =TokenProvider.getInstance().getToken();
	...
	@Test
	public void nbfc_email_double_dot()
	{
		JSONObject request=new JSONObject();
		String token =TokenProvider.getInstance().getToken();
	...
	@Test
	public void nbfc_email_without_dot_com()
	{
		JSONObject request=new JSONObject();
		String token =TokenProvider.getInstance().getToken();

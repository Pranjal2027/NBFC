...
public class TC_04_Get_Payment_Invoice_History extends Base_Class_1
{
	   ...
	   @Test
		public void Get_Payment_Invoice_History()
		{
	   ...
	   @Test
		public void Get_Payment_Invoice_History_No_Payment()
		{
		  ...
		  String token = TokenProvider.getInstance().getToken();
			   ...
			   header("authorization","Bearer " + token).
			  when().
			      get(CONTEXTPATH + "collection/invoices/635a46250f3f22b2a90ebdf6/paymenthistory").   
			   then().log().all().
			    statusCode(200); 
		}
}

...
import org.testng.annotations.BeforeClass;
import org.testng.annotations.Test;
public class TC_14_edit_User_Admin extends Base_Class
{
    @BeforeClass
	public void setup()
	{
	...
	public void edit_User_Admin()
	{
		...
		request.put("updatedAt","2022-12-08");
 		 ...
 		 given().
		   ...
		   when().
		      put(CONTEXTPATH + "user/63aa7ecccd025999c1fdf19a").//XuritiAdmin
		   then().
		   log().all().
		    statusCode(200);
	 	}

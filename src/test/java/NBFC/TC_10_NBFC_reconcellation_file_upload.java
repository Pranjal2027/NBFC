...
public class TC_10_NBFC_reconcellation_file_upload extends Base_Class
{
    @BeforeClass
	public void setup()
	{
    ...
    @Test
	public void nbfc_file_upload()
	{
		JSONObject request=new JSONObject();
		String token =TokenProvider.getInstance().getToken();

 		File testUploadFile = new File ("Excel/rec.csv");
		...
		Response response = given()
				...
				.when().
				post(CONTEXTPATH+"nbfcs/"+ NBFCID +"/nbfc-reconcellation");

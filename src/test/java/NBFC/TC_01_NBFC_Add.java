...
public class TC_01_NBFC_Add extends Base_Class
{
	...
	public void nbfc_post()
	{
		...
		String token =TokenProvider.getInstance().getToken();
		 ...
		 request.put("nbfc_name", "Godrej Properties");
		 request.put("nbfc_email", "pranjal.sul@tech-trail.com");
		 request.put("nbfc_mobile", "9924418498");
		 ...
		 request.put("email", "vis74@gmail.com");
		 request.put("mobile_number", "9965241069");

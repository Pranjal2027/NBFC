...
public class TC_04_NBFC_edit_by_id extends Base_Class
{
    ...
    @Test
	public void nbfc_update()
	{
		JSONObject request=new JSONObject();
		String token =TokenProvider.getInstance().getToken();
		request.put("nbfc_name", "Bajaj Finance Limited");
		 request.put("nbfc_email", "pgwade202@gmail.com");
		 request.put("nbfc_mobile", "9874563216");
		 ...
		 request.put("email", "vasha12345@gmail.com");
		 request.put("mobile_number", "8521479650");
		 request.put("user_role", "nbfcUser");
 		 given().
		   ...
		   when().
		      put(CONTEXTPATH + "nbfcs/edit-nbfc/635f913e97c1dfb63839e799").
		   then().
		   log().all().
		    statusCode(200);
	 	}
